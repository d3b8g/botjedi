<? 
define('CALLBACK_API_CONFIRMATION_TOKEN', '0c4514e0'); // Строка, которую должен вернуть сервер 
define('VK_API_ACCESS_TOKEN', 'f93b8546c7c8801d5c9707ab82219b034d7a76cfd54090901c3d61c43e0510c90c764ce5bf38dfe4ac7ac'); // Ключ доступа сообщества 
...
switch ($event['type']) { 
  ...
  case CALLBACK_API_EVENT_MESSAGE_NEW: 
    ...
    send_message($peer_id, "Пожалуйста, подпишись на сообщество! (peer_id: {$peer_id})"); 
    echo('ok'); 
    break; 
  default: 
